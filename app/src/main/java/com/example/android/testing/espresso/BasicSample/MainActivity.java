...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.TextChangeButton).setOnClickListener(this);
        findViewById(R.id.activityChangeTextBtn).setOnClickListener(this);

        mTextView = (TextView) findViewById(R.id.TextToBeChanged);
        mEditText = (EditText) findViewById(R.id.editUserTextInput);
    }
    ...
    public void onClick(View view) {
        ...
        final int changeTextBtId = R.id.TextChangeButton;
